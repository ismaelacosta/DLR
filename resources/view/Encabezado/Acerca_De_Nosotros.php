...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">ACERCA DE NOSOTROS</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col">
        ...
        <h2>Socios</h2>
        <p>
          - Roberto Ismael Acosta López <BR>
          - Roberto Vega Villanueva
        </p>
          ...
          <Table> 
            <tbody>
                <tr>
                    ...
                    <td>
                        L18111934@itcj.edu.mx <BR>
                        L18111958@itcj.edu.mx
                    </td>
                </tr>
                <tr>
                    <td>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <h2 class="pb-2 border-bottom">ACERCA DE LA PÁGINA</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>Solo en Juárez</h2>
          <p>Por el momento DLR solo hace entregas de mercancía en el área de Cd. Juárez</p>
        </div>
      </div>
    </div>
  </div>
