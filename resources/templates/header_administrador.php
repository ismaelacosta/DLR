...
<header>
  <div class="container-fluid">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="https://dulcerialr.000webhostapp.com/resources/view/inicio/inicio_administrador.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="../inicio/inicio_administrador.php"class="nav-link"><b><font color="black">Página principal</font></b></a></li>
